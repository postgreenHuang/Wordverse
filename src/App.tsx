...
export default function App({ projectName, onRequestProjectManager }: { projectName?: string; onRequestProjectManager?: () => void } = {}) {
  ...
  const nodeContextPending = useRef(false)
  ...
  const cancelActiveMode = () => { setLinkMode('off'); setLinkSourceIds([]); setDuplicateSourceId(''); setContextMenu(null); setSceneContextMenu(null) }
